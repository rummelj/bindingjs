...
_api.preprocessor.preprocess = (viewDataBinding) => {
    ...
    // Step 9: Prevent iterating over the same element more than once
    ...
    // Step 10: Move Bindings that affect iterated elements into the iteration
    _api.preprocessor.transform.nestIteratedBindings(bind)
    
    // Step 11: Setup iteration tree
